...
#define asMETHOD(c,m) AS_NAMESPACE_QUALIFIER asSMethodPtr<sizeof(void (c::*)())>::Convert(as_func_cast<c>(&c::m))
...
public:
	...
	// Object types
	virtual int            RegisterObjectType(const char *obj, int byteSize, asQWORD flags, const char *base = nullptr) = 0;
...
inline constexpr int asBCTypeSize[24] =
{
	0, // asBCTYPE_INFO
	1, // asBCTYPE_NO_ARG
	1, // asBCTYPE_W_ARG
