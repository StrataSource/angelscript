...
public:
	...
	// Type registration
	virtual int            RegisterObjectType(const char *obj, int byteSize, asQWORD flags, const char *base = nullptr);
	...
	// Namespaces
	virtual asUINT       GetNamespaceCount() const;
	virtual const char  *GetNamespaceByIndex( asUINT index ) const;
